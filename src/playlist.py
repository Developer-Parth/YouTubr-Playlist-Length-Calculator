...
class Playlist:
    ...
    def get_output_string(self):
        ...
        output_string += [
            ...
            "At 0.25x : " + parse(self.total_duration / 0.25),
            "At 0.50x : " + parse(self.total_duration / 0.5),
            "At 0.75x : " + parse(self.total_duration / 0.75),
            "At 1.00x : " + parse(self.total_duration),
